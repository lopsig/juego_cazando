...
imagenGato.src =
  "https://toppng.com/uploads/preview/cat-cartoon-png-png-stock-imagenes-de-gato-animados-11562902291ec1yppnujs.png"; // ← el nombre de tu archivo PNG
...
const graficarGato = () => {
  if (imagenCargada) {
    ...
    // Fallback: si la imagen aún no cargó, dibuja el rectángulo
    graficarRectagulo(gatoX, gatoY, ANCHO_GATO, ALTO_GATO, COLOR_GATO);
  }
};
